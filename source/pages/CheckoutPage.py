from NoAmazon.source.SeleniumExtended import SeleniumExtended
from NoAmazon.source.pages.locators.CheckoutPageLocators import CheckoutPageLocators
...
class CheckoutPage(CheckoutPageLocators):
    ...
    def select_country_dropdown(self, country):
        country = 'Canada' if not country else country
    ...
    def select_state_dropdown(self, state):
        state = 'New Brunswick' if not state else state
